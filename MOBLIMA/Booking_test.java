    ...
    public static void main(String args[]) throws IOException {
        ...
        for(int i=0;i< cinema_list.size();i++){
            ...
            for(int j=0;j<cinema_list.get(i).getSeats_row();j++){
                for(int y=0;y<cinema_list.get(i).getSeats_col();y++){
            ...
            ShowTime s = new ShowTime("201212071345",movie_list.get(1),seat_s,Day.WEEKEND,cinema_list.get(i));
            showtime_list.add(s);
        }
        ...
        //test for payment display.
        /*
        PaymentDisplay payment = new PaymentDisplay(7.50f,showtime_list.get(0));
        payment.generateTid();
        */
        //test updatemovie;
        MovieListingStaff mls = new MovieListingStaff();
        mls.DisplayMenu();

        //try reviewRatingdisplay:
